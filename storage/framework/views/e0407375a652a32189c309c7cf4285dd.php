    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="form-group">
                ...
                <div class="form-icon-user">
                    <?php echo e(Form::select('branch_id', $branchs, null, ['class' => 'form-control ', 'required' => 'required', 'placeholder' => __('Select Branch')])); ?>
        ...
        <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="form-group">
                ...
                <div class="form-icon-user">
                    <?php echo e(Form::select('department_id', $departments, null, ['class' => 'form-control ', 'required' => 'required', 'placeholder' => __('Select Department')])); ?>
