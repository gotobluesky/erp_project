                        ...
                        <div class="row">
                            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                <div class="btn-box">
                                    ...
                                    <?php echo e(Form::date('start_date', request('start_date'), ['class' => 'month-btn form-control current_date', 'autocomplete' => 'off'])); ?>
                            ...
                            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                <div class="btn-box">
                                    ...
                                    <?php echo e(Form::date('end_date', request('end_date'), ['class' => 'month-btn form-control current_date', 'autocomplete' => 'off'])); ?>
                            ...
                            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                <div class="btn-box">
                                    ...
                                    <?php else: ?>
                                        ...
                                        <?php echo e(Form::select('employee', $employeesList, request('employee'), ['class' => 'form-control select', 'id' => 'employee_id'])); ?>
                    ...
                    <table class="table" id="pc-dt-simple">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $timeSheets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $timeSheet): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <?php if(\Auth::user()->type != 'employee'): ?>
                                        <td><?php echo e($timeSheet['employee_name'] ?? ''); ?></td>
                                    <?php endif; ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ix8ccsto9l8d/public_html/f100.com.mx/nomina/resources/views/timeSheet/index.blade.php ENDPATH**/ ?>