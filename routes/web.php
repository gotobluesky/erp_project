...
use App\Http\Controllers\SubdepartmentController; // Importación del controlador de Subdepartamentos
...
Route::group(['middleware' => ['verified']], function () {
    ...
    Route::resource('/biometric-attendance', BiometricAttendanceController::class)->middleware(['auth', 'XSS']);
