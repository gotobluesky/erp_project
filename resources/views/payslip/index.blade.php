                    ...
                    <div class="d-flex align-items-center justify-content-end">
                        <div class="col-xl-2 col-lg-3 col-md-6 col-sm-12 col-12 mx-2">
                            <div class="btn-box">
                                <Label class="form-label">Fecha de inicio</Label>
                                    ...
                                    <input type="date"  name="start" class="form-control" id="datePicker11" value={{date_format($start,"Y-m-d")}}>
                            </div>
                        </div>
                        <div class="col-xl-2 col-lg-3 col-md-6 col-sm-12 col-12 mx-2">
                            <div class="btn-box">
                                <Label class="form-label">Fecha final</Label>
                                    <input type="date"  name="end" class="form-control" id="datePicker12" value={{date_format($end,"Y-m-d")}}>
                            </div>
                        </div>
                        ...
                        <div class="col-auto float-end ms-2 mt-4">
                            <a href="#" class="btn  btn-primary"
                                id="searchdata"
                                data-bs-toggle="tooltip" title="{{ __('payslip') }}"
                                data-original-title="{{ __('payslip') }}">{{ __('Payslip list') }}
                            </a>
                        </div>
                    </div>
                    {{ Form::close() }}
