   ...
   <tbody>
    @foreach ($attendances as $attendance)
        <tr>
            ...
            <td>{{ $attendance['employee_name'] }}</td> <!-- Mostrar el nombre del empleado -->
                ...
                @if (Gate::check('Biometric Attendance Synchronize'))
                    <div class="action-btn bg-info ms-2">
                        <form method="POST" action="{{ route('biometric-attendance.update', $attendance['id']) }}">
                            ...
                            <button type="submit" class="btn btn-primary btn-sm" data-ajax-popup="false" data-size="sm" data-bs-toggle="tooltip" title="{{ __('Sync') }}">
                                {{ __('Sync') }}
                            </button>
                        </form>
                    </div>
